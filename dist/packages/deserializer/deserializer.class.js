...
var Deserializer = (function () {
    ...
    Deserializer.prototype.normalize = function () {
        var eachRecursively = function (object) {
            for (var key in object) {
                ...
                if (lodash_1.isObject(object[key])) {
    ...
    Deserializer.prototype.getReturnObject = function (wasDeserialized) {
